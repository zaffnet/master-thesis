...
Following these core metrics, we investigate behavioural outcomes including quit attempts and self-reported changes, explore conversation dynamics both quantitatively and qualitatively (\Cref{sec:conversation-dynamics}), and examine illustrative case studies and sample outliers. Finally, we analyse participant feedback (\Cref{sec:feedback}) and discuss broader implications of our findings (\Cref{sec:synthesis}).
...
Three open-ended questions captured immediate post-conversation reactions. Thematic analysis revealed distinct patterns in positive and negative responses (see Appendix~\ref{app-feedback} for a selection of verbatim responses).
