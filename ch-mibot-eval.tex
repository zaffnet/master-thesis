...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.32\textwidth}
    ...
    \caption{\%CT}
  \end{subfigure}
  \caption[MISC Summary Score Distributions]{Comparison of MISC summary score distributions for MIBot and the HLQC dataset (high and low quality). The figure shows violin plots for (a) Percentage MI-Consistent Responses (\%MIC), (b) Reflection to Question Ratio (R:Q), and (c) Percentage Client Change Talk (\%CT).}
...
\begin{table}[ht]
  ...
  \begin{tabular}{@{}lcc@{}}
    ...
    \bottomrule
  \end{tabular}
  \caption[User Experience Segments]{Segmentation of users based on their reported enjoyment and perceived helpfulness of the MIBot conversation. The table shows the percentage of participants in each of the four segments: Enthusiasts, Entertained Sceptics, Reluctant Beneficiaries, and Dissatisfied.}
