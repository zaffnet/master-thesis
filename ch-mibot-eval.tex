...
While the results are promising, the study also revealed limitations in building deep therapeutic alliance and translating engagement into perceived helpfulness for all users. These findings establish a strong proof-of-concept for AI-delivered MI as a scalable public health intervention, while also underscoring the areas for future research and development. One significant challenge in this development process is the need for rapid, scalable, and cost-effective testing of chatbot iterations. Relying solely on human studies for this purpose is slow and resource-intensive. This challenge motivates the exploration of an alternative evaluation paradigm: the use of LLM-based synthetic users. The following chapter details our initial work in developing and validating such synthetic smokers.
