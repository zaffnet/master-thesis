			...
			\begin{threeparttable}
				...
				\begin{tabular}{@{}l@{\hspace{3pt}}c|c|c|c|c|c|c|c|c|c@{\hspace{3pt}}c@{}}  % Tighter spacing
					...
					\rotatebox{45}{\scriptsize really listening}                                          &
                                        \rotatebox{45}{\scriptsize \makecell[l]{being interested \\ in you as a \\ whole person}} &
                                        \rotatebox{45}{\scriptsize \makecell[l]{fully understanding \\ your concerns}}         &
					...
					\rotatebox{45}{\scriptsize helping you take control}                                  &
                                        \rotatebox{45}{\scriptsize \makecell[l]{making a plan \\ of action with you}}          &
...
Conversations ranged from 36 to 163 utterances (median 78; mean 80.71, SD 25.54), with counsellor utterances comprising 71.7\% of the total. The median conversation lasted approximately 30 minutes. \Cref{table:conversation-dynamics} summarizes the main quantitative metrics.
