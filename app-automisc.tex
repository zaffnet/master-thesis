...
\begin{tcolorbox}[
	...
	You are a highly accurate Motivational Interviewing (MI) counselling session annotator.
        Your task is to segment the given volley into utterances.\par\medskip
...
\begin{tcolorbox}[breakable,
        ...
        You are a highly accurate Motivational Interviewing (MI) counselling session annotator.\par
        Your task is to analyze an excerpt from a counselling session of up to five volleys and categorize the counsellor's final utterance.\par\medskip
	...
	\end{enumerate}
        ...
        Behavioural Code Guide:\par\medskip
