...
\hline
\textbf{MIBot v5.2} & Introduced adaptive follow-up prompts and branching logic. Expanded conversational flow based on clients' responses to open-ended questions. Most sophisticated hybrid scripted-generative version. & Nov 22–29, 2022 & \citet{brown2023mi} \\
\hline
\textbf{GPT-4 BLCR} & Prototype reflection generator only version using GPT-4 to generate Backward-Looking Complex Reflections (BLCRs). %These links new clients' utterances to their prior statements.
%Tested offline for coherence and fidelity.
& Oct 2023
& \citet{brown2023mi} \\
\hline
\textbf{MIBot v6.3A} &
