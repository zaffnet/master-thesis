...
Following the development and deployment of the MIBot system, a feasibility study was designed to evaluate its real-world performance and safety. This chapter details the methodology of that study, whose primary goals were to measure the effect of a single-session interaction with MIBot on smokers' motivation and to assess the chatbot's safety for delivery to ambivalent individuals.
