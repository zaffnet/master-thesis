...
This thesis has pursued two parallel and interconnected research streams: the development and evaluation of a generative MI chatbot, MIBot, and the creation of data-driven synthetic smokers for automated testing and training. Having detailed the specific findings from each of these areas, this concluding chapter synthesizes the overall contributions, acknowledges the limitations of the work, and outlines promising directions for future research.
